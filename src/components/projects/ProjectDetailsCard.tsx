    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="p-4 lg:p-6 border-b border-[#0000004D] flex flex-wrap items-center justify-between gap-4">
        <div className="flex  items-center gap-4">
          <div className="size-14 bg-[#EAF2FE] rounded-[14px] flex items-center justify-center text-[#435FB3]">
            <Landmark size={28} />
          </div>
          <div className="space-y-1">
            ...
            <p className="text-[#637381] font-inter text-base">Q-2025-1047</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-b border-[#0000004D]">
        <div className="p-3 md:p-6 flex items-start gap-4 last:border-r-0">
          <div className="text-[#637381] mt-1"><Building size={20} /></div>
          <div>
            <p className="text-base text-[#000000] font-inter font-medium mb-1">Building Type</p>
        ...
        <div className="p-3 md:p-6 flex items-start gap-4  last:border-r-0">
          ...
          <div>
            <p className="text-base text-[#000000] font-inter font-medium mb-1">Quote Value</p>
        ...
        <div className="p-3 md:p-6 flex items-start gap-4  last:border-r-0">
          ...
          <div>
            <p className="text-base text-[#000000] font-inter font-medium mb-1">Created On</p>
            <p className="text-sm text-[#212B36] font-inter font-semibold">{project.createdOn || "N/A"}</p>
          </div>
        </div>
        <div className="p-3 md:p-6 flex items-start gap-4">
          <div className="text-[#637381] mt-1"><MapPin size={20} /></div>
          <div>
            <p className="text-base text-[#000000 font-inter font-medium mb-1">Location</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3">
        {/* Contact Information */}
        <div className="p-3 md:p-6 space-y-4 border-r border-gray-100 last:border-r-0 text-[#000000]">
          <h3 className="text-sm font-inter font-medium ">Contact Information</h3>
          <div className="bg-[#F9FAFB] p-4 rounded-xl space-y-3">
            <p className="text-sm font-inter font-medium text-[#000000]">{customerName}</p>
            <div className="flex items-center gap-3 text-sm text-[#637381]">
              <Phone size={14} />
              <span>Phone: <span className=" font-medium">{customerPhone}</span></span>
            </div>
            <div className="flex items-center gap-3 text-sm text-[#637381]">
              <Mail size={14} />
            ...
            <div className="flex items-start gap-3 text-sm text-[#111827]">
              ...
              <span>Address: <span className=" font-medium">{customerAddress}</span></span>
            </div>
          </div>
        </div>

        {/* Assignment */}
        <div className="p-3 md:p-6 space-y-4 border-r border-gray-100 last:border-r-0">
