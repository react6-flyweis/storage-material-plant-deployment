      ...
      <div className="p-3 lg:p-4 bg-white border-t border-gray-200 mt-auto">
        <form onSubmit={onSendMessage} className="flex items-center gap-2">
          <button
            ...
            className="p-2.5 rounded-xl border border-gray-200 text-gray-500 hover:text-blue-600 hover:border-blue-300 hover:bg-blue-50 transition-colors disabled:opacity-50"
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2.5 bg-slate-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#4285F4] focus:bg-white text-sm placeholder:text-gray-400 shadow-2xs h-[44px]"
            />
          </div>
          ...
          <Button
            ...
            className="h-[44px] px-5 flex items-center gap-2 rounded-xl"
          >
            <Send size={16} />
