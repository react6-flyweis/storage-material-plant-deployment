...
import type { ChatConversation } from "@/redux/api/teamChatApi";
  ...
  return (
    <div className="hidden md:flex w-72 lg:w-80 border-r border-gray-200 flex-col bg-white shrink-0">
      ...
      <div className="p-4 flex items-center justify-between border-b border-gray-100">
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <div
              className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white ${isConnected ? "bg-emerald-500" : "bg-amber-400"
                }`}
      ...
      <div className="flex border-b border-gray-100 mb-2 px-2">
        <button
          className={`flex-1 py-2.5 text-sm font-semibold transition-all relative ${activeTab === "Departments"
            ? "text-[#4285F4]"
        ...
        <button
          className={`flex-1 py-2.5 text-sm font-semibold transition-all relative ${activeTab === "Direct"
            ? "text-[#4285F4]"
            : "text-gray-400 hover:text-gray-600"
            }`}
        ...
        {activeTab === "Departments" ? (
            ...
            groupItems.map((group) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-center justify-between p-3 cursor-pointer rounded-xl transition-all group ${isSelected
                  ...
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-1">
                        <span
                          className={`text-xs lg:text-sm font-semibold transition-colors truncate ${isSelected
                            ? "text-[#4285F4]"
          ...
          <div className="p-6 text-center text-xs text-gray-400 flex flex-col items-center">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#4285F4] text-white text-xs font-semibold rounded-lg hover:bg-blue-600 shadow-xs transition-all"
            >
              <Plus size={14} />
              Start New Chat
            </button>
      ...
      <div className="p-3 border-t border-gray-100 flex flex-col gap-2">
        {activeTab === "Direct" && (
          <button
            onClick={onOpenNewChat}
            className="w-full flex items-center justify-center gap-2 py-2 bg-[#4285F4] hover:bg-blue-600 active:scale-[0.99] text-white rounded-xl text-xs font-semibold shadow-xs transition-all"
          >
            <Plus size={15} />
