            ...
            <tr className="bg-[#F7F8F9] border-b border-[#F4F6F8] text-nowrap">
              ...
              <th className="py-4 px-4 text-sm font-archivo font-semibold text-black">
                <div className="flex items-center gap-1">
                  Client <ArrowUpDown size={14} className="text-[#5D6772]" />
                </div>
              </th>
              ...
              <th className="py-4 px-4 text-sm font-archivo font-semibold text-black">
                <div className="flex items-center gap-1">
                  Sent Date <ArrowUpDown size={14} className="text-[#5D6772]"/>
                </div>
              </th>
              <th className="py-4 px-4 text-sm font-archivo font-semibold text-black">Status</th>
              ...
              <tr key={idx} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="py-4 px-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm md:text-base font-archivo font-normal text-black">{item.clientName}</span>
                  </div>
                </td>
                ...
                <td className="py-4 px-4 text-sm md:text-base font-inter text-[#637381]">{item.sentDate}</td>
                <td className="py-4 px-4">
