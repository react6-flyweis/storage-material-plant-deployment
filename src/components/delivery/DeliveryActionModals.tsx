...
export const RescheduleSuccessModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => (
  <SuccessModal 
    isOpen={isOpen} 
    onClose={onClose} 
    title="" 
  ...
  >
    <div className="text-center space-y-6 mb-8">
      <h2 className="text-2xl md:text-3xl font-bold text-[#212B36] leading-tight px-4">
        Your delivery for <br/> <span className="font-extrabold">*Primary Frame Steel*</span> <br/> has been rescheduled.
      </h2>
      
      <div className="space-y-2 py-4">
        <p className="text-lg font-semibold text-[#212B36]">New Date: March 27</p>
        <p className="text-lg font-semibold text-[#212B36]">Time Window: 10:00 AM – 2:00 PM</p>
        <p className="text-lg font-semibold text-[#212B36]">Contact: John Site Manager</p>
      </div>
    </div>
  </SuccessModal>
);
